...
namespace Musala.Infrastructure
{
    ...
    public abstract class MusalaEntity<T> : IValidatableObject
    {
        ...
        {
            if (obj == null || !(obj is MusalaEntity<T>))
            {
                return false;
            }
        ...
        public static bool operator ==(MusalaEntity<T> left, MusalaEntity<T> right)
        {
            if (Equals(left, null))
            {
