...
namespace Musala.GatewayMgmt.Repositories.Ef.Repositories
{
    ...
    public abstract class RepositoryInt<T> : Repository<T, int>, IRepository<T, int>, IDisposable where T : MusalaEntity<int>
    {
        /// <summary>
        ...
        public override T FindById(int id, params Expression<Func<T, object>>[] includeProperties)
        {
